...
All vocabulary terms are stored in `/src/data/vocabulary.ts` as a static TypeScript array. The app contains 500+ tech terms organized into 24 categories, from foundational concepts to advanced topics like AI, security, and architecture.
...
- **ID 141-500+:** Additional categories (No-Code, Security, Mobile, etc.)
